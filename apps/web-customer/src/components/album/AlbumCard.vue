<template>
  <div class="card bg-white rounded-[18px] overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,.08)] hover:-translate-y-1.5 hover:shadow-[0_8px_40px_rgba(0,0,0,.12)] transition-all cursor-pointer"
